---
title: "Spotify Sort"
description: A Python app that uses Color Coherence Vectors in order to sort Spotify Playlists. Built with Numpy and OpenCV, based on a paper from Cornell University.
date: "2023-02-08"
