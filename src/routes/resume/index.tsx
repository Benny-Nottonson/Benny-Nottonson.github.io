      ...
      <div class="px-6 pt-16 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        <div class="max-w-2xl mx-auto lg:mx-0">
          ...
          <p class="mt-4 text-zinc-400">
            Below is my resume, a downloadable version is available <a
            target="_blank"
            href="../Tech.pdf"
        ...
        <div class="w-full h-px bg-zinc-800" />
          ...
          <li class="mt-4 text-zinc-400">
                <p>
                    <span class="font-bold">Student</span> at <a
                    target="_blank"
            ...
            <li class="mt-4 text-zinc-400">
                <p>
                    <span class="font-bold">Dance Instructor</span> at <a
                    target="_blank"
            ...
            <li class="mt-4 text-zinc-400">
                <p>
                    <span class="font-bold">Web Developer</span> at <a
                    target="_blank"
